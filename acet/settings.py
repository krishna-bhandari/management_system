...
ALLOWED_HOSTS = ['192.168.100.18','localhost','0.0.0.0',]
...
WSGI_APPLICATION = 'acet.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS=[os.path.join(BASE_DIR,'acet/static')]
